...
The row mixin needs to be applied on the elements that will contain your columns items
...
This class allows you to tell a grid column to adapt its width **depending on its content**
...
All these mixins described above are great but this forces you to write a lot of @include... to do complex things. The universal mixin is here to help you with that.
It allows you to write in one line all you want from gridle in your element.
...
Gridle has a support for element queries (Thanks to [Marc J Schmidt](https://github.com/marcj/css-element-queries) for his wonderfull work on the "polyfill"). To make your element responsive to its own width, use this mixin as described bellow
...
Sometimes you want to apply more than one mixin on your item. This can be a pain to write multiple times @include gridle_... You now have this mixin to help you with this.
